        ...
        <>
            ...
            <SafeAreaView style={styles.container}>
                ...
                >
                    ...
                    <ThemedText style={styles.sectionTitle}>{t('settings.helpInfo') || 'Help & Support'}</ThemedText>
                    </View>
                    ...
                    <View style={styles.sectionHeader}>
                    <ThemedText style={styles.sectionTitle}>{t('settings.faq') || 'Frequently Asked Questions'}</ThemedText>
                    </View>
                    ...
                    <View style={styles.sectionHeader}>
                    <ThemedText style={styles.sectionTitle}>{t('settings.contactUs') || 'Contact Us'}</ThemedText>
                    </View>
