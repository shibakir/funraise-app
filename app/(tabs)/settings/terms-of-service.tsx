        ...
        <ThemedView style={styles.container}>
          ...
          >
            <View style={styles.sectionHeader}>
              <ThemedText style={styles.sectionTitle}>{t('settings.terms') || 'Terms of Service'}</ThemedText>
            </View>
            
            <ThemedView style={[styles.mainSection, { backgroundColor: sectionBackground }]}>
              <ThemedText style={styles.description}>
                {t('settings.termsContent') || 'Terms of Service content will be displayed here.'}
              </ThemedText>
              <ThemedText style={styles.description}>
